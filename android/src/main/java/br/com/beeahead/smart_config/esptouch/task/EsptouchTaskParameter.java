...
public class EsptouchTaskParameter implements IEsptouchTaskParameter {
    ...
    public EsptouchTaskParameter() {
        mIntervalGuideCodeMillisecond = 16;
        mIntervalDataCodeMillisecond = 16;
        mTimeoutGuideCodeMillisecond = 4000;
        mTimeoutDataCodeMillisecond = 8000;
        mTotalRepeatTime = 2;
        ...
        mWaitUdpSendingMillisecond = 255000;
